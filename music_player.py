...
class Player(tk.Frame):
	...
	def track_widgets(self):
		...
		self.songtrack['text'] = 'Audics MP3 Player'
	...
	def audio(self):
		# self.path='F:\vs code\Python\Audio\PDF%20AudioBook\application.py'
		# call(["Python3","{}".format(self.path)])	
		# tk.after(3000)

		# os.system('F:\vs code\Python\Audio\PDF%20AudioBook\application.exe')
		# app.mainloop()
		# StopIteration()
